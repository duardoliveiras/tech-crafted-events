      ...
      button.addEventListener("click", function () {
        ...
        fetch(`/comments/${commentId}/toggle-vote/${voteType}`, {
          ...
          .then((data) => {
            ...
            let voteCountElement = document.getElementById(
              `vote-count-${commentId}`
            );
...
function toggleEdit(commentId) {
  ...
  let editCommentInput = document.getElementById(
    "editCommentInput-" + commentId
  );
  let buttonSave = document.getElementById("button-save-" + commentId);

  commentText.style.display =
    commentText.style.display === "none" ? "block" : "none";
  editCommentInput.style.display =
    editCommentInput.style.display === "none" ? "block" : "none";
  buttonSave.style.display =
    buttonSave.style.display === "none" ? "block" : "none";
}

// Function to save changes
function saveChanges(commentId) {
  let editedText = document.getElementById(
    "editCommentInput-" + commentId
  ).value;
  ...
  fetch(`/comments/${commentId}`, {
    ...
    .then((response) => {
      if (response.ok) {
        ...
        document.getElementById("commentText-" + commentId).textContent =
          editedText;
