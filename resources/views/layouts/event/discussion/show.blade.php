        ...
        <div class="card-body">
            ...
            <form action="{{ route('discussion.comment', ['event' => $event->id, 'discussion' => $discussion->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="file" class="form-control custom-input" id="attachment" name="attachment" accept="image/jpeg, image/png, image/jpg, image/gif, image/svg+xml, application/pdf, .txt">
