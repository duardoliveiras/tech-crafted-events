                ...
                <div class="card mb-4 shadow-sm" style="transition: transform .2s;">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card-body">
                                <button type="button" class="btn btn-outline-danger position-absolute top-0 end-0" data-toggle="modal" data-target="#reportModal">
...
<div class="modal fade" id="reportModal" tabindex="-1" role="dialog" aria-labelledby="reportModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
        ...
        <form>
          <div class="form-group">
            ...
            <label for="reportDescription"> Description </label>
                <textarea type="text" class="form-control" id="reportDescription" placeholder="Provide more details"></textarea>
          </div>
        </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
        <button type="button" class="btn btn-primary">Enviar Report</button>
      </div>
    </div>
  </div>
</div>
    ...
    <script type="text/javascript" src="{{ URL::asset('js/event/report-event.js') }}"></script>
