        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('event-report.store', [$event->id]) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="reportReason" name="reportReason">
                                ...
                                <option value="Inappropriate Behavior at the Event">Inappropriate Behavior at the
                                    Event
                                </option>
                            ...
                            <textarea name="reportDescription" class="form-control" id="reportDescription"
