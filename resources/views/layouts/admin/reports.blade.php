                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                        ...
                                        onClick="getEventReportsView('{{ $event->id }}','{{ $event->name}}', 'event')">
                                    <svg class="bi" width="16" height="16">
                                        <use xlink:href="{{ asset('assets/svg/icons.svg#eye-fill') }}"></use>
                                    </svg>
                                    View
                                </button>

                                <button type="button" class="btn btn-success"
                                        onclick="check_all_event('{{ $event->id }}' )">
                                    <svg class="bi" width="16" height="16">
                                ...
                                <button type="button" class="btn btn-danger" onClick="banEvent( '{{ $event->id }}' )">
                                    <svg class="bi" width="16" height="16">
                                        <use xlink:href="{{ asset('assets/svg/icons.svg#ban-fill') }}"></use>
                                    </svg>
                                    Ban
                                </button>
                            </td>
                    ...
                    @forelse ($comments as $comment )
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#reportModal"
                                        onClick="getEventReportsView('{{ $comment->user->id }}','{{ $comment->user->name }}', 'comment')">
                                    <svg class="bi" width="16" height="16">
                                        <use xlink:href="{{ asset('assets/svg/icons.svg#eye-fill') }}"></use>
                                    </svg>
                                    View
                ...
                <div class="container mt-3">
                    <div class="input-group">
                        <select class="form-control form-control-sm" id="reportReason" name="reportReason">
                            ...
                            <option value="Inappropriate Behavior at the Event">Inappropriate Behavior at the Event
                            </option>
