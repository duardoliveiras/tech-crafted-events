                    ...
                    <form action="{{ route('profile.update', $user->id) }}" method="POST" id="update-form" enctype="multipart/form-data">
                        ...
                        <div class="form-row mb-3">
                            ...
                            <div class="w-100 d-flex align-content-center justify-content-center">
                                <img class="rounded-circle shadow-1-strong mb-2" id="preview" src="{{ $user->image_url ? asset('storage/' . $user->image_url) : 'https://static-00.iconduck.com/assets.00/user-icon-2048x2048-ihoxz4vq.png' }}" alt="avatar" />
                            </div>
