    ...
    <div class="w-100">
        <h6 class="fw-bold mb-0" style="font-size: 1.05rem;">
            ...
            @if($comment->user->id === auth()->id())
                ...
                <a href="javascript:void(0);" class="link-muted text-decoration-none text-reset ms-2 button-delete"
                       id="button-edit" onclick="confirmDelete('{{ $comment->id }}')" title="Delete comment">
                ...
                <a href="javascript:void(0);" class="link-muted text-decoration-none text-reset ms-2 button-delete"
                       id="button-report" onclick= title="Report comment"  data-toggle="modal" data-target="#reportModal" >
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#d3d7cf" class="bi bi-trash3-fill" viewBox="0 0 16 16">
...
<style>
    .button-edit:hover svg, .button-delete:hover svg, #downvote-not-filled:hover, #upvote-not-filled:hover {
        transition: .5s;
        fill: #666666;
    }
</style>
