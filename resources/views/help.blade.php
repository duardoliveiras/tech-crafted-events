        ...
        <div class="accordion accordion-flush" id="faqAccordion">
            ...
            <div class="accordion-item">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#faqAccordion">
                    <div class="accordion-body">To sign up for a new account, click the 'Sign Up' button on the top right of the page, and fill in your details in the form provided.</div>
                </div>
            </div>
            <!-- FAQ Item 2 -->
            <div class="accordion-item">
                ...
                <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#faqAccordion">
                    <div class="accordion-body">Our customer support team is available 24/7. Click on the 'Contact Us' link at the bottom of the page for contact information.</div>
                </div>
            </div>
            <div class="accordion-item">
            ...
            <div class="accordion-item">
                ...
                <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#faqAccordion">
                    <div class="accordion-body">You can change your account settings by navigating to your account dashboard and selecting 'Profile' and then selecting 'Edit profile'.</div>
                </div>
            </div>
            <div class="accordion-item">
